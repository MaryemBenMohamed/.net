...
namespace AM.UI.WEB.Controllers
{
    public class TicketController : Controller
    {
        ...
        public ActionResult Index(string? prix, string? siege)
        {

            if (prix == null)
                return View(tcktsrv.GetAll().ToList());
            else
                return View(tcktsrv.GetTicketByPrice(prix).ToList());
            if (siege == null)
                return View(tcktsrv.GetAll().ToList());
            else
                return View(tcktsrv.GetTicketBySiege(prix).ToList());
            if (prix == null && siege == null)
                return View(tcktsrv.GetAll().ToList());
            else
                return View(tcktsrv.GetTicketByPriceAndSiege(prix,siege).ToList());
        ...
        {
            ViewBag.PassengerFK = new SelectList(psgsrv.GetAll(), "Id", "FullName.FirstName");
            ViewBag.FlightFK = new SelectList(flgtsrv.GetAll(), "FlightId", "Destination");
            return View();
        }
